...
parser.add_argument("--input_train_dir", default="../02_Data/UNSW_NB15_training-set.csv")
parser.add_argument("--input_test_dir", default="../02_Data/UNSW_NB15_testing-set.csv")
parser.add_argument("--init_seed", type=int, default=3, help="Random seed")
parser.add_argument("--data_dir", default="../04_Output/data")
