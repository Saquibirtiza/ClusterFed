...
parser.add_argument("--dataset", default="UNSW_IoT", choices=["CIFAR10", "CIFAR100, UNSW_IoT"])
parser.add_argument("--n_clients", type=int, default=10)
parser.add_argument("--alpha", type=float, default=0.1, choices=[1e-3, 1e-2, 1e-1, 1e0, 1e1, 1e2, 1e3, 1e4, 1e5])
...
parser.add_argument("--input_train_dir", default="/home/sxi190002/Saquib/Federated Learning/orchestra/UNSW_NB15_training-set.csv")
parser.add_argument("--input_test_dir", default="/home/sxi190002/Saquib/Federated Learning/orchestra/UNSW_NB15_testing-set.csv")
...
class UNSW_IoT_Dataset(Dataset):
...
def load_UNSW_IoT_data(traindir, testdir, num_Class):
    ...
    # Create PyTorch datasets
    trainval_dataset = UNSW_IoT_Dataset(X_train, y_train)
    test_dataset = UNSW_IoT_Dataset(X_test, y_test)
...
if(args.dataset=="CIFAR10"):
    ...
    test_data = datasets.CIFAR100(f'{args.data_dir}/dataset/CIFAR100', train=False, download=True,
        transform=transforms.Compose([transforms.ToTensor()]))
elif(args.dataset=="UNSW_IoT"):
    n_classes = 10
    train_data, test_data = load_UNSW_IoT_data("/home/sxi190002/Saquib/Federated Learning/orchestra/UNSW_NB15_training-set.csv", "/home/sxi190002/Saquib/Federated Learning/orchestra/UNSW_NB15_testing-set.csv", 10)
...
print(n_samples_train, n_samples_test)
